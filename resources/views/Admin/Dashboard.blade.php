...
<head>
    ...
    <!-- App CSS -->
    <link rel="stylesheet" href="{{ asset('AdminPanel/css/app-light.css') }}" id="lightTheme" disabled>
    <link rel="stylesheet" href="{{ asset('AdminPanel/css/app-dark.css') }}" id="darkTheme">
...
<body class="vertical  dark  ">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink"
                        ...
                        <span class="avatar avatar-sm mt-2">
                            <img src="{{asset('AdminPanel/assets/avatars/face-1.jpg')}}" alt="Profile Picture" class="avatar-img rounded-circle">
                        </span>
                    </a>
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('social.create')}}"><span
                                        class="ml-1 item-text">Add Social Link</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('skill.create')}}"><span
                                        class="ml-1 item-text">Add Skill</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('category.create')}}"><span
                                        class="ml-1 item-text">Add Category</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('education.create')}}"><span
                                        class="ml-1 item-text">Add Education</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('professional.create')}}"><span
                                        class="ml-1 item-text">Add Professional...</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('testimonial.create')}}"><span
                                        class="ml-1 item-text">Add Testimonial</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('service.create')}}"><span
                                        class="ml-1 item-text">Add service</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('portfolio.create')}}"><span
                                        class="ml-1 item-text">Add Portfolio</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('about.create')}}"><span
                                        class="ml-1 item-text">Add About</span></a>
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('social.index')}}">
                                    <span class="ml-1 item-text">Social Links</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('skill.index')}}"><span
                                        class="ml-1 item-text">Your Skills</span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('education.index')}}"><span
                                        class="ml-1 item-text">Education</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('professional.index')}}"><span
                                        class="ml-1 item-text">Professional Experience</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('testimonial.index')}}"><span
                                        class="ml-1 item-text">Testimonial</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('service.index')}}"><span
                                        class="ml-1 item-text">Services</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('portfolio.index')}}"><span
                                        class="ml-1 item-text">Portfolio</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="{{route('about.index')}}"><span
                                        class="ml-1 item-text">About</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <script src="{{ asset('AdminPanel/js/daterangepicker.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/jquery.stickOnScroll.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/tinycolor-min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/config.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/d3.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/topojson.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/datamaps.all.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/datamaps-zoomto.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/datamaps.custom.js') }}"></script>
    ...
    <script src="{{ asset('AdminPanel/js/gauge.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/apexcharts.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/apexcharts.custom.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/jquery.mask.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/select2.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/jquery.steps.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/jquery.timepicker.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/dropzone.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/uppy.min.js') }}"></script>
    <script src="{{ asset('AdminPanel/js/quill.min.js') }}"></script>
    <script>
        $('.select2').select2({
            theme: 'bootstrap4',
        });
